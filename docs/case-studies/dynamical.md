...
:::{image} /img/case-studies/dynamical-light.svg
:alt: dynamical.org logo
:class: case-study-logo only-light
:::

:::{image} /img/case-studies/dynamical-dark.svg
:alt: dynamical.org logo
:class: case-study-logo only-dark
:::

## <span>dynamical\.org</span> Datasets on Source
...
&mdash; **Marshall Moutenot, <span>dynamical.org</span> Founder**

## <span>dynamical.org</span> Shares Through Source Cooperative

<span>dynamical.org</span> created a public, live-updating catalog of Zarr-formatted weather datasets that are:
...
- **Organizational Growth:** Enabled <span>dynamical.org</span> to demonstrate impact, helping secure support from NOAA and Amazon, while allowing them to focus on scientific work and data homogenization rather than fundraising for infrastructure.
...
## Find Out More About <span>dynamical.org</span>

Learn more about <span>dynamical\.org</span>: [www.dynamical.org](https://www.dynamical.org)
